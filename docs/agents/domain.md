...
The stdio package is active; hosted MCP and its HTTP/OAuth/container code are retired and absent under engineering:CLAUDE.md.
...
- `src/server.ts`: stdio tool/resource/prompt composition.
