  ...
  server.registerTool(
    "varity_deploy",
    {
      ...
      description:
        ...
        "Automatically detects the framework (Next.js, React, Vue, Express, FastAPI, etc.), " +
        "builds the project, and ships it live at https://varity.app/<name>/. " +
        "Zero configuration required. Dramatically cheaper than Vercel / Railway / Render. " +
